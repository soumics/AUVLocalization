...
function [A]= Ang_transd_inv(ang_dang)
...
e11=0;
e12=0;
e13=-cos(theta)*thetad;
e21=0;
e22=-sin(phi)*phid;
e23=cos(phi)*phid*cos(theta)-sin(phi)*sin(theta)*thetad;
e31=0;
e32=-cos(phi)*phid;
e33=-sin(phi)*phid*cos(theta)-cos(phi)*sin(theta)*thetad;
%(cos(phi)*sin(theta)/cos(theta)^2)*thetad-(sin(phi)/cos(theta))*phid;
